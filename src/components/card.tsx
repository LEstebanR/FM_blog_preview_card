...
const Card: React.FC<props> = ({ cardData }) => {
  return (
    <div className="flex h-4/6 max-h-100 w-11/12 max-w-96 flex-col items-center justify-around rounded-lg border bg-white p-4 shadow-card hover:shadow-hover">
      <img className="h-3/6 rounded-lg" src={cardData.image} />
